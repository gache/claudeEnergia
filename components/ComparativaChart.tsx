    ...
    <div className="bg-white rounded-2xl shadow-card-md border border-slate-100 p-6">
      ...
      <ResponsiveContainer width="100%" height={260}>
        <BarChart data={chartData} maxBarSize={18} barGap={3}>
          ...
          />
          <Bar dataKey={String(year1)} fill={colors[String(year1)]} radius={[4, 4, 0, 0]} animationDuration={1100} animationEasing="ease-out" />
          <Bar dataKey={String(year2)} fill={colors[String(year2)]} radius={[4, 4, 0, 0]} animationDuration={1100} animationEasing="ease-out" />
        </BarChart>
      </ResponsiveContainer>
      </div>
      </div>
