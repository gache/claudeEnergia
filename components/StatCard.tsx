...
const accentMap: Record<string, { iconBg: string; iconColor: string; border: string }> = {
  brand:   { iconBg: "bg-brand-50",   iconColor: "text-brand-600",   border: "border-t-[3px] border-brand-500" },
  hc:      { iconBg: "bg-cyan-50",    iconColor: "text-hc-600",      border: "border-t-[3px] border-hc-500" },
  hp:      { iconBg: "bg-amber-50",   iconColor: "text-hp-600",      border: "border-t-[3px] border-hp-500" },
  violet:  { iconBg: "bg-violet-50",  iconColor: "text-violet-600",  border: "border-t-[3px] border-violet-500" },
  savings: { iconBg: "bg-savings-50", iconColor: "text-savings-600", border: "border-t-[3px] border-savings-500" },
};

export default function StatCard({
  titulo, valor, unidad, subLabel, icono: Icono,
  variacion, colorIcono, accentColor = "brand",
}: Props) {
